...
```
2/HMAC_SHA256(H+SHA256(E)) partner-id=examplemerchant, key-id=1, timestamp=1402285260, signed-headers=Content-Type, signature=9df1f39b8030f56ffb77b8f4662f462c916a02f8e85a566441ee82a2639de5a1
```
...
| Param name |  Description  | Type | Example | Required |
|:-----------|:--------------|:-----|:--------|:--------:|
...
[comment]: <> (    &lt;merchant-id&gt;gatewaymerchant&lt;/merchant-id&gt;)
[comment]: <> (    &lt;merchant-request-id&gt;1002001&lt;/merchant-request-id&gt;)
[comment]: <> (    &lt;msisdn&gt;14155551234&lt;/msisdn&gt;)
[comment]: <> (    &lt;optin-type&gt;otp&lt;/optin-type&gt;)
[comment]: <> (&lt;/optin-request&gt;)
[comment]: <> (</span></pre>)
...
7f333176b8cfba5699bdce5d7064e666f04e947480825ec27b95a02d27d4460e
1401143938
```
...
```
Content-Type: text/plain
3033985f254cbe0db21c9527d45b3fc66a28f88fff34d8fcdef4757ce169bb98
1401143938
```
